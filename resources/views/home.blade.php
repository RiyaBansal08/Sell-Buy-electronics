  ...
  @extends('header')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-center" style="color: #2C9934;">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>About Us</h2>
                <p>We belive in making the world a better place for our future generation. </p>
            </div>

            <div class="row content">
                <div class="col-lg-6">
                    <p>
                        We can provide you best value of your products that you are going to sell here, as we donot give
