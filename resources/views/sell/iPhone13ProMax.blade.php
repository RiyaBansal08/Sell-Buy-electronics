    ...
    <div class="container mt-5 mb-3">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 marginCol ">
                ...
                <div class="">
                    <span class="model">Apple iPhone 13 pro max</span>
                </div>
                <span class="" >
                    <span class="primary-text">100</span>+&nbsp;already&nbsp;sold&nbsp;on ProjectX</span>

                <div class=""><span class="">Choose a variant</span><br>
                    <button type="button" class="btn btn-light">
                        <a style="text-decoration: none;" href="{{route('i13promax_64gb')}}"><span >64GB</span></a>
                    </button>
                    <button type="button" class="btn btn-light">
                        <a  style="text-decoration: none;" href=""><span >128GB</span></a>
                    </button>
                    <button type="button" class="btn btn-light">
                        <a  style="text-decoration: none;" href=""><span >256GB</span></a>
                    </button>
                </div>
                <div class="" id="">
                    <button class="btn btn-success" tabindex="-1" type="button" style="min-height:42px" disabled>
                        <span class="">
                            <span class="" style="text-transform:none">Get Exact Value
                            </span>
                        </span>
                    </button>
                </div>
