...
<body>
    ...
    <div class="container" style="margin-top: 5rem;">
        <div class="row mt-5  justify-content-center align-items-center" style="background-color: rgb(219, 196, 196);">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-5">
                <h1 class="heading">Terms and conditions</h1>

            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-5">
                <img src="https://cdni.iconscout.com/illustration/premium/thumb/investment-agreement-3428349-2912142.png"
                    class="img-fluid" alt="Terms and condtions">
            </div>
        ...
        <div class="row mt-5 mb-5">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <h1 class="h1tag">Acknowledgment</h1>
                ...
                <h1 class="h1tag">Limitation of Liability</h1>
                ...
                <h1 class="h1tag">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
                ...
                <h1 class="h1tag">Governing Law</h1>
                ...
                <h1 class="h1tag">Disputes Resolution</h1>
                ...
                <h1 class="h1tag">For European Union (EU) Users</h1>
                ...
                <h1 class="h1tag">United States Legal Compliance</h1>
                ...
                <h1 class="h1tag">Severability and Waiver</h1>
                <h2>Severability</h2>
                ...
                <ul>
                    <li>
                        <p>By email: raghavmoudgil99@gmail.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a
                                href="https://raghav0training.000webhostapp.com/preojectX/body/index.html"
                                rel="external nofollow noopener"
                                target="_blank">Project X</a>
                        </p>
                    </li>
                    <li>
                        <p>By phone number: +91 8278145655</p>
                    </li>
                </ul>
            </div>
